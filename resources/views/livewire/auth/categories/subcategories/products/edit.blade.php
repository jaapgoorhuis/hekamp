            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form  x-data="{ buttonDisabled: false}" x-on:livewire-upload-start="buttonDisabled = true" x-on:livewire-upload-finish="buttonDisabled = false" >
                        ...
                        <br/>
                        <hr class="rounded">
                        <h5 class="form-section-title">Uploads:</h5>
                        <small>Afbeeldingen, video's en PDF bestanden zijn toegestaan</small>
                        <br/>
                        ...
                        @if(count($this->downloads))
                            <hr class="rounded">
                            <h5 class="form-section-title">Bestanden:</h5>
                            <small>De volgorde van de bestanden zijn aan te passen door ze op volgorde te slepen. </small>
                            <br/>
                            <br/>
                            <br/>
                            <div class="accordion" id="accordionExample">
