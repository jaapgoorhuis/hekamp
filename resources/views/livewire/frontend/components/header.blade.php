...
<head>
    ...
    @endif
    <link rel="icon" type="image/x-icon" href="{{env('ASSET_URL')}}/storage/images/frontend/favicon.ico">
...
@endif
        <nav class="navbar navbar-expand-lg bg-body-tertiary">
            <div class="container-fluid">
                ...
                <a class="navbar-brand" href="/{{$locale}}/index"><img src="{{env('ASSET_URL')}}/storage/images/frontend/hekamp_logo.png"/></a>
        ...
        <div class="header-image" style="background-image:url('{{env('ASSET_URL')}}/storage/images/frontend/header.jpg');">
