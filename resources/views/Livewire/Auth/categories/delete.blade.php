                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="removeModalLabel">Categorie verwijderen</h5>
                            <button type="button" class="btn-close" wire:click="cancel" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                            Weet u zeker dat u deze categorie wilt verwijderen? Alle subcategorieën worden ook verwijderd.
                        </div>
