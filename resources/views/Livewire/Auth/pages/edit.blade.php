                        ...
                        <div class="form-section">
                            <div class="form-group mb-3">
                                <div
                                    ...
                                    x-on:livewire-upload-finish="fileUploaded = true"
                                    ...
                                    <input @if($this->header_image) disabled @endif type="file" class="form-control @error('header_image') is-invalid @enderror" id="header_image" wire:model="header_image">
                                        <div
                                    ...
                                    @if($this->header_image)
                                        ...
                                        <div class="project-upload-preview-container">
                                            <div class="project-upload-preview-box">
                                                <i wire:click="removeHeaderImage()" class="fa-solid fa-trash"></i>
                                                @if(is_string($this->header_image))
                                                    <img src="{{asset('storage/images/frontend/uploads/'.$this->header_image) }}"/>
                                                @else
                            ...
                            <div wire:ignore>
                                <div class="form-group mb-3" wire:ignore>
                                    ...
                                    <textarea id="header_text" wire:model.defer="header_text">{{$this->header_text}}</textarea>
                                    @error('header_text')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
