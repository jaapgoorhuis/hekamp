                    ...
                    <form>
                        ...
                        <div class="form-section">
                            <div class="form-group mb-3">
                                ...
                                <select wire:model.live="block_id" class="form-control">
                                    @foreach($this->blocks as $block)
                                        <option value="{{$block->id}}">{{$block->friendly_name}}</option>>
                                    @endforeach
                                </select>
                                @error('block_id')
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" id="name" class="form-control @error('name') is-invalid @enderror" wire:model.live="name"/>
                                @error('name')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
