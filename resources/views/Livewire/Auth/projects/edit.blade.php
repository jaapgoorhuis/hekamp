                        ...
                        <div class="form-section">
                            <div class="form-group mb-3">
                                <div
                                    ...
                                    <input @if($this->tumbnail) disabled @endif type="file" class="form-control @error('tumbnail') is-invalid @enderror" id="tumbnail" wire:model="tumbnail">
                        ...
                        <div class="form-section">
                            <div wire:ignore>
                                <div class="form-group mb-3" wire:ignore>
                                    ...
                                    <textarea id="small_description" wire:model="small_description">{{$this->small_description}}</textarea>
                        ...
                        <div class="form-section">
                            <div wire:ignore>
                                <div class="form-group mb-3" wire:ignore>
                                    ...
                                    <textarea id="description" wire:model.defer="description">{{$this->description}}</textarea>
                                    @error('description')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
