...
<div class="l-navbar" id="backend-nav">
    <nav class="nav">
        <div>
            <a href="#" class="nav_logo"> <i class='bx bx-layer nav_logo-icon'></i> <span class="nav_logo-name">Crewa</span> </a>
            <div class="nav_list">
                ...
                <a href="/auth/projects" class="nav_link"> <span class="nav_name">Projecten</span> </a>
